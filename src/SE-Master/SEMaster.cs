...
namespace SE_Master
{
    public partial class SEMaster : Form
    {
        ...
        {
            btnClose.BackColor = Color.FromArgb(63, 62, 67);
        }

        private void Button1_MouseLeave(object sender, EventArgs e)
        {
            btnClose.BackColor = Color.FromArgb(23, 22, 27);
        }

        private void Button2_MouseHover(object sender, EventArgs e)
        {
            btnMinimize.BackColor = Color.FromArgb(63, 62, 67);
        }

        private void Button2_MouseLeave(object sender, EventArgs e)
        {
            btnMinimize.BackColor = Color.FromArgb(23, 22, 27);
        }
        private void Button3_MouseHover(object sender, EventArgs e)
        {
            btnInfo.BackColor = Color.FromArgb(63, 62, 67);
        }

        private void Button3_MouseLeave(object sender, EventArgs e)
        {
            btnInfo.BackColor = Color.FromArgb(23, 22, 27);
        }
